...
func (repo *PaymentImpl) RepoList(ctx context.Context, limit, offset uint64) (resPayment []models.Payment, err error) {
...
func (repo *PaymentImpl) RepoFindByid(ctx context.Context, id uint64) (resPayment models.Payment, err error) {
...
func (repo *PaymentImpl) RepoCreate(ctx context.Context, paymentIn models.Payment) (resPayment models.Payment, err error) {
...
func (repo *PaymentImpl) RepoUpdate(ctx context.Context, paymentIn models.Payment) (resPayment models.Payment, err error) {
